//
//  NumberMemoryExtremeViewController.swift
//  BrainBooster
//
...
final class NumberMemoryExtremeViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        for textField in numberTextFields {
            ...
            (textField as? CustomTextField)?.numberMemoryExtremeVC = self
        }
    }
    ...
    private func finish() {
        ...
        updateRecord(for: .numberMemory, mode: .extreme, timeType: countdownTime, score: score)
...
extension NumberMemoryExtremeViewController: UITextFieldDelegate {
...
extension NumberMemoryExtremeViewController: UIPickerViewDelegate {
...
extension NumberMemoryExtremeViewController: UIPickerViewDataSource {
