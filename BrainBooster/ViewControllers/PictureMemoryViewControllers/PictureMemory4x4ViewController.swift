//
//  PictureMemory4x4ViewController.swift
//  BrainBooster
//
...
final class PictureMemory4x4ViewController: UIViewController {
    ...
    private func finish() {
        ...
        updateRecord(for: .pictureMemory, mode: .fourByFour, time: countdownTime)
        stopCountDownTimer()
